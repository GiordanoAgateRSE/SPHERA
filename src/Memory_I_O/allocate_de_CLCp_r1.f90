...
!-------------------------------------------------------------------------------
!-------------------------------------------------------------------------------
! Program unit: allocate_de_CLCp_r1
! Description: Allocation/Deallocation of a generic allocatable array of 
!              derived type CLC_polygon_der_type and range (number of 
!              dimensions) 1
!-------------------------------------------------------------------------------
#ifdef SPACE_3D
...
!------------------------
implicit none
type (CLC_polygon_der_type),dimension(:),allocatable,intent(inout) :: array
