...
!------------------------
array_name = "Vertice"
call allocate_de_dp_r2(.false.,Vertice,array_name=array_name,ulog_flag=.true.)
...
call allocate_de_int4_r1(.false.,BFaceList,array_name=array_name,              &
   ulog_flag=.true.)
array_name = "CLC%z0"
call allocate_de_dp_r2(.false.,CLC%z0,array_name=array_name,ulog_flag=.true.)
#endif
...
#endif
array_name = "Partz"
call allocate_de_Zon_r1(.false.,Partz,array_name=array_name,ulog_flag=.true.)
array_name = "Med"
call allocate_de_Med_r1(.false.,Med,array_name=array_name,ulog_flag=.true.)
array_name = "OpCount"
call allocate_de_int4_r1(.false.,OpCount,array_name=array_name,ulog_flag=.true.)
array_name = "SpCount"
call allocate_de_int4_r1(.false.,SpCount,array_name=array_name,ulog_flag=.true.)
array_name = "EpCount"
call allocate_de_int4_r1(.false.,EpCount,array_name=array_name,ulog_flag=.true.)
...
call allocate_de_CtlLin_r1(.false.,Control_Lines,array_name=array_name,        &
   ulog_flag=.true.)
array_name = "pg"
call allocate_de_Par_r1(.false.,pg,array_name=array_name,ulog_flag=.true.)
array_name = "ts0_pg"
...
call allocate_de_int4_r1(.false.,NPartOrd,array_name=array_name,               &
   ulog_flag=.true.)
array_name = "Icont"
call allocate_de_int4_r1(.false.,Icont,array_name=array_name,ulog_flag=.true.)
...
call allocate_de_dp_r2(.false.,PartKernel,array_name=array_name,               &
   ulog_flag=.true.)
array_name = "rag"
call allocate_de_dp_r2(.false.,rag,array_name=array_name,ulog_flag=.true.)
...
enddo
array_name = "body_arr"
call allocate_de_Bod_r1(.false.,body_arr,array_name=array_name,ulog_flag=.true.)
array_name = "bp_arr"
...
call allocate_de_int4_r1(.false.,PartIntorno_bp_f,array_name=array_name,       &
   ulog_flag=.true.)
array_name = "proxy_normal_bp_f"
call allocate_de_int4_r1(.false.,proxy_normal_bp_f,array_name=array_name,      &
   ulog_flag=.true.)
...
call allocate_de_dp_r1(.false.,KerDer_bp_f_Gal,array_name=array_name,          &
   ulog_flag=.true.)
array_name = "rag_bp_f"
call allocate_de_dp_r2(.false.,rag_bp_f,array_name=array_name,ulog_flag=.true.)
...
call allocate_de_dp_r2(.false.,rag_bp_bp,array_name=array_name,ulog_flag=.true.)
