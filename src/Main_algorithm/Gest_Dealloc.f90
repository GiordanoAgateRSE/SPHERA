...
! Statements
!------------------------
write(ulog,'(1x,a)') ">> Storage deallocation in routine "//trim(nomsub)
check = .true.
if (allocated(Vertice)) then
   deallocate(Vertice,stat=alloc_stat)
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: VERTICE successfully deallocated "
   endif
endif
...
if (allocated(BoundaryFace)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: BoundaryFace successfully deallocated"
   endif
endif
...
if (allocated(Partz)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: PARTZ successfully deallocated "
   endif
endif
if (allocated(Med)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: MED successfully deallocated "
   endif
endif
if (allocated(OpCount)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: OpCount successfully deallocated "
   endif
endif
if (allocated(SpCount)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: SpCount successfully deallocated "
   endif
endif
if (allocated(EpCount)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: EpCount successfully deallocated "
   endif
endif
...
if (allocated(NPartOrd)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: NPARTORD successfully deallocated "
   endif
endif
if (allocated(Icont)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: ICONT successfully deallocated "
   endif
endif
if (allocated(nPartIntorno)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: nPartIntorno successfully deallocated"
   endif
endif
if (allocated(PartIntorno)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: PartIntorno successfully deallocated "
   endif
endif
if (allocated(PartKernel)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: PartKernel successfully deallocated "
   endif
endif
if (allocated(rag)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: rag successfully deallocated "
   endif
endif
if (allocated(BoundaryDataTab)) then
   ...
   if (alloc_stat/=0) then
      ...
      write(ulog,'(1x,a)') "   Array: BoundaryDataTab successfully deallocated"
   endif
endif
...
if (allocated(Array_Flu)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: Array_Flu successfully deallocated "
   endif
endif
   ...
   if (allocated(Icont_w)) then
      ...
      if (alloc_stat/=0) then
         ...
         stop
            ...
            write(ulog,'(1x,a)') "   Array: ICONT_w successfully deallocated "
      endif
   endif
   ...
   if (allocated(kernel_fw)) then
      ...
      if (alloc_stat/=0) then
         ...
         stop
            ...
            write(ulog,'(1x,a)') "   Array kernel_fw successfully deallocated"
        endif
   endif
   if (allocated(rag_fw)) then
      ...
      if (alloc_stat/=0) then
         ...
         stop
            ...
            write(ulog,'(1x,a)') "   Array: rag_fw successfully deallocated "
      endif
   endif
endif
do i=1,n_bodies
   if (allocated(body_arr(i)%body_kinematics)) then
      ...
      if (alloc_stat/=0) then
         write(uerr,'(1x,2a,i2)') "   Array: body_arr(i)%body_kinematics not", &
...
if (allocated(body_arr)) then
   ...
   if (alloc_stat/=0) then
      ...
      write(ulog,'(1x,a)') "   Array: body_arr successfully deallocated "
   endif
endif
if (allocated(bp_arr)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: bp_arr successfully deallocated "
   endif
endif
if (allocated(Icont_bp)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: Icont_bp successfully deallocated "
   endif
endif
if (allocated(NPartOrd_bp)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: NPartOrd_bp successfully deallocated "
   endif
endif
...
if (allocated(rag_bp_f)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: rag_bp_f successfully deallocated "
   endif
endif
...
if (allocated(rag_bp_bp)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: rag_bp_bp successfully deallocated "
   endif
endif
...
if (allocated(GCBFVector)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: GCBFVector successfully deallocated "
   endif
endif
if (allocated(GCBFPointers)) then
   ...
   if (alloc_stat/=0) then
      ...
      stop
         ...
         write(ulog,'(1x,a)') "   Array: GCBFPointers successfully deallocated"
   endif
endif
if(allocated(Q_sections%section)) then
   ...
   if (alloc_stat/=0) then
      write(uerr,*) 'Deallocation of "Q_sections%section" in the subroutine ', &
...
do i=1,substations%n_sub
   if (allocated(substations%sub(i)%DEMvert)) then
      deallocate(substations%sub(i)%DEMvert,STAT=alloc_stat)
      if (alloc_stat/=0) then
         write(uerr,*) 'Deallocation of "substations%sub(',i,')%DEMvert" in ', &
            'the subroutine "Gest_Dealloc" failed; the ',                      &
            'execution terminates here.'
         stop
         else
            write(ulog,*) 'Deallocation of "substations%sub(',i,')%DEMvert" ', &
               'in the subroutione "Gest_Dealloc" is successfully completed.'
      endif
   endif
enddo
if (allocated(substations%sub)) then
   deallocate(substations%sub,STAT=alloc_stat)
   if (alloc_stat/=0) then
      write(uerr,*) 'Deallocation of "substations%sub" in the ',               &
         'subroutine "Gest_Dealloc" failed; the execution terminates here.'
      stop
      else
         write(ulog,*) 'Deallocation of "substations%sub" in the ',            &
...
if(allocated(Granular_flows_options%lines)) then
   ...
   if (alloc_stat/=0) then
      write(uerr,*) 'Deallocation of Granular_flows_options%lines failed; ',   &
         'the program stops here. '
      call diagnostic(arg1=4,arg2=1,arg3=nomsub)       
      else
         write(ulog,'(1x,a)') "Deallocation of Granular_flows_options%lines ", &
...
if (allocated(DBSPH%kinematics)) then
   ...
   if (alloc_stat/=0) then
      write(uerr,*) 'Deallocation of DBSPH%kinematics in ',                    &
         'GestDealloc failed; the program terminates here. '
      call diagnostic(arg1=5,arg2=340)       
      else
         write(ulog,'(1x,a)') "Deallocation of DBSPH%kinematics ",             &
...
if (allocated(DBSPH%n_kinematics_records)) then
   ...
   if (alloc_stat/=0) then
      write(uerr,*) 'Deallocation of DBSPH%n_kinematics_records in ',          &
         'GestDealloc failed; the program terminates here. '
      call diagnostic(arg1=5,arg2=340)
      else
         write(ulog,'(1x,a)') "Deallocation of DBSPH%n_kinematics_records ",   &
            "in GestDealloc successfully completed."
   endif
endif
if (allocated(DBSPH%rotation_centre)) then
   ...
   if (alloc_stat/=0) then
      write(uerr,*) 'Deallocation of DBSPH%rotation_centre in ',               &
         'GestDealloc failed; the program terminates here. '
      call diagnostic(arg1=5,arg2=340)
      else
         write(ulog,'(1x,a)') "Deallocation of DBSPH%rotation_centre ",        &
            "in GestDealloc successfully completed."
   endif
endif
if (allocated(DBSPH%inlet_sections)) then
   ...
   if (alloc_stat/=0) then
      write(uerr,*) 'Deallocation of DBSPH%inlet_sections in GestDealloc ',    &
         'failed; the program terminates here.'
      call diagnostic(arg1=5,arg2=340)       
      else
         write(ulog,'(1x,2a)') "Deallocation of DBSPH%inlet_sections in ",     &
...
if (allocated(DBSPH%outlet_sections)) then
   ...
   if (alloc_stat/=0) then
      write(uerr,*) 'Deallocation of DBSPH%outlet_sections in GestDealloc ',   &
         'failed; the program terminates here.'
      call diagnostic(arg1=5,arg2=340)       
      else
         write(ulog,'(1x,2a)') "Deallocation of DBSPH%outlet_sections in ",    &
            "GestDealloc successfully completed."
   endif
endif
if (check) return
