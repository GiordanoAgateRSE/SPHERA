...
PgZero%dens = zero
PgZero%volume = zero
PgZero%dden_ALE12 = zero
PgZero%pres = zero
PgZero%dden = zero
PgZero%dmass_dt = 0.d0
PgZero%uni = zero
PgZero%zer(1) = zero
PgZero%zer(2) = zero
PgZero%zer(3) = zero
...
1000 format (                                                                  &
1x,'------------------------------------------------------------------------'/ &
1x,'This output file is generated by SPHERA v.10.0.0 (Smoothed Particle Hydrodynamics'/ &
1x,'research software; mesh-less Computational Fluid Dynamics code).        '/ &
1x,'Copyright 2005-2022 (RSE SpA-formerly ERSE SpA, formerly CESI RICERCA,  '/ &
1x,'formerly CESI-Ricerca di Sistema; SPHERA v.10.0.0 is authored for RSE SpA by:'/&
...
1x,'Roberto Guandalini, David Zuccalà, Emanuela Abbate, Qiao Cheng).        '/ &
