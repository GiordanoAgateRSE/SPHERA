...
!$omp private(tau_s,ALE1_CE_BODY,ALE2_CE_BODY,aux_scalar)
...
! Possible correction for the velocity divergence (mirror velocity as solid 
! velocity)
               dvar(1:3) = dvar(1:3)
         endif
!Note: in any case, no-slip conditions require no correction
      endif
