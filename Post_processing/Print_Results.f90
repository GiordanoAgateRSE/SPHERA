...
integer(4) :: minloccodi,maxloccodi,minlocInEn,maxlocInEn,minvelo,maxvelo
integer(4) :: minlocvelo_w,maxlocvelo_w,minlocpres_w,maxlocpres_w
integer(4) :: minlocvelo_bp,maxlocvelo_bp,minlocpres_bp,maxlocpres_bp,nbi
...
integer(4) :: minlocu_star,maxlocu_star,machine_Julian_day,machine_hour
integer(4) :: machine_minute,machine_second
